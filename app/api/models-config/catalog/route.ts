...
// GET /api/models-config/catalog?q=<model-id>&provider=<name>&baseUrl=<url>&limit=<n>
// Searches the public models.dev catalog and recommends metadata
// (context window, modalities, pricing) for a model id.
